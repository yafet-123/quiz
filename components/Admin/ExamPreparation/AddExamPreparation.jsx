...
export function AddExamPreparation({ subjects }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post("/api/exam-preparation/add", {
        subjectId,
        topicTitle,
        books: allBooks,
      });

      setSuccess("Topic and books added successfully!");
      setSubjectId("");
      setTopicTitle("");
      setBooks([]);
      setCurrentBook({ name: "", link: "" });
    ...
    <div className="flex flex-col items-center min-h-screen py-24 px-4 lg:px-6 bg-gray-50">
      <div className="w-full max-w-3xl bg-white shadow-lg rounded-2xl p-8">
        <h1 className="text-3xl font-bold text-center mb-10 flex items-center justify-center gap-2 text-gray-800">
          <FiPlusCircle className="text-[#009688] text-4xl" />
          Add Exam Preparation Topic
        </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <select
              ...
              required
              className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#009688]"
            >
          ...
          <div className="border p-4 rounded-xl bg-gray-50">
            ...
            <input
              ...
              className="w-full mb-2 px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#009688]"
            />
            ...
            <button
              type="button"
              onClick={addBook}
              className="mt-2 bg-[#009688] hover:bg-[#00796b] text-white px-4 py-2 rounded-xl font-medium"
            >
              Add This Book
            </button>
          </div>
          ...
          <div className="flex justify-center mt-6">
            ...
            >
              {loading ? "Submitting..." : "Submit Topic & Books"}
            </button>
          </div>
        </form>
      </div>
