...
export default function BookDetail({ notes }) {
  return (
    <div className="antialiased bg-gray-50">
      <MainHeader title="Aceit : Revision Note Individual Page" />
      <div className="flex pt-20">
        ...
        <div className="w-full px-4 md:px-10 py-10">
          ...
          {/* Note Card */}
          <div className="max-w-6xl mx-auto bg-white rounded-2xl shadow-lg p-8 md:p-12 border border-gray-200 overflow-hidden">
            ...
            <div
              className="prose prose-purple max-w-none text-gray-800 overflow-x-auto"
