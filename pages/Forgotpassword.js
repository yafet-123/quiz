...
export default function ForgotPassword() {
  ...
  return (
    <React.Fragment>
      ...
      <div className="flex justify-center items-center min-h-screen bg-gradient-to-tr from-blue-50 via-indigo-50 to-purple-50 px-4">
        <div className="flex flex-col items-center w-full max-w-md lg:max-w-lg">
          
          {/* Hero Icon */}
          <div className="bg-blue-100 p-5 rounded-full mb-6 animate-bounce">
            <HiOutlineLockClosed className="text-blue-700 w-12 h-12" />
          </div>

          <div className="bg-white w-full rounded-3xl shadow-2xl p-8 lg:p-12 flex flex-col">
